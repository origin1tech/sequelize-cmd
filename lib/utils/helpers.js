...
function Helpers(){
    ...
    return {
         ...
         * @param {array} strip - an array of keys to strip/remove.
         * @returns {object}
         */
         ...
         * @param {array} include - an array of keys to include.
         * @returns {object}
         */
        normalizeOptions: function normalizeOptions(options, include) {
