...
function SqCmd(sequelize, options, logger) {
    ...
    defaults = {
        ...
        migration: {
            ...
            autoSeed: false,               // when true seeding will run after migrations.
            ...
            typeVariable: 'type',          // the variable name for your datatypes.
            ...
            // there are several other keys you may need that are excluded by default.
            // for example common properties often defined globally are not auto
            // generated in the migration output. such as: paranoid, underscored,
            // timestamps, createdAt, updatedAt, deletedAt, omitNull, freezeTableName
            validOptions: [
                'classMethods',
                'instanceMethods',
                'validate',
    ...
    cmds = {
        ...
        addModel: { alias: ['createModel', 'newModel', 'generateModel', 'addmodel'], event: self.addModel },
        addMigration: { alias: ['createMigration', 'newMigration', 'generateMigration', 'addmigration'], event: self.addMigration },
        addSeed: { alias: ['createSeed', 'newSeed', 'generateSeed', 'addseed'], event: self.addSeed },
        ...
        if(!raw){
            ...
            _.forEach(data, function (v,k) {
                data[k] = {
                    ...
                    attributes: helpers.normalizeAttributes(v.attributes),
                    options: helpers.normalizeOptions(v.options, self.migConf.validOptions)
